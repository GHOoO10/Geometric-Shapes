...
shape_type = input("Choose the type of shape (circle or c , triangle or t, rectangle or r): ").lower()
...
if shape_type == "circle" or shape_type == "c":
    ...
    side2 = float(input("Enter the length of the scound side of the triangle: "))
    ...
    print("The Shape type is incorrect!")